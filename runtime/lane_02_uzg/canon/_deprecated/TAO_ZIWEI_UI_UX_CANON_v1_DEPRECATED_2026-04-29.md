...
**Cấm:**
- Pop-up tự động đề xuất "Xem lá số của bạn ngay!" (vi phạm L5 no-fear-UX)
- Notification spam "Hôm nay là ngày tốt cho bạn..." (vi phạm REDLINE 4 no-manipulation)
- Banner trên HOME feed kiểu "Lá số bí ẩn của bạn..." (vi phạm REDLINE 2 no-mysticism-shock)
...
**UX principles:**
- Timeline visualization clean, không decorative
- "Window" framing: "thời điểm thuận cho X" / "thời đoạn cần cẩn trọng với Y" — KHÔNG "ngày tốt / ngày xấu"
- All advisory paragraphs neutral framing

**Cấm:**
- Calendar widget với "lucky day" / "unlucky day" labels (REDLINE 4)
- Push notification "Hôm nay là ngày kỵ" (REDLINE 4)
- Countdown to "đại hạn" event (fear-UX → L5)
...
# **SECTION 5 — REDLINE COMPLIANCE CHECKLIST**

Pre-publish review gate. UI/UX changes ship only after PASS:

- [ ] No deterministic language ("sẽ", "chắc chắn", "không thể tránh khỏi")
- [ ] No fear-based UX (red alerts for "hung", countdown to "hạn xấu")
- [ ] No mystical shock copy ("bí ẩn", "tiết lộ", "vận mệnh chấn động")
- [ ] No "thầy phán" tone in AIER Tao
- [ ] No "lucky day / unlucky day" calendars
- [ ] No score/rating for chart aspects
- [ ] No notifications based on "ngày tốt"
