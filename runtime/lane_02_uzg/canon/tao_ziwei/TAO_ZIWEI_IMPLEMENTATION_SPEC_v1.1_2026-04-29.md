...
**Version:** 1.1 (VN-school explicit confirmation)
...
Per NTS school lock 2026-04-29, TAO V2 (Tử Vi) calendar boundaries follow **Vietnamese school**:

| Pillar | Boundary | Same as Tử Vi V2? |
|---|---|---|
| Year | Tết Nguyên Đán (mùng 1 tháng Giêng âm lịch) | YES — V2 default |
| Month | Mùng 1 lunar month | YES — V2 default |
| Day | JDN-based | YES |
| Hour | 12 giờ chi với Tý phase rollover (early Tý 23:00-23:59 → next day; late Tý 00:00-00:59 stays) | YES |

**Cross-engine integrity (LAW 3 v1.1):**
Bazi (TAO V1) và Tử Vi (TAO V2) MUST produce identical 4 pillars cho cùng 1 user. Any disagreement = engine bug → halt.

**Cross-source validation:**
- Use VN-school references: lịch vạn niên Việt Nam, sách Tử Vi Việt Nam (e.g., Vũ Tài Lục, Thái Vân Trình), lyso.vn, tuviglobal.com
- DO NOT use classical Chinese tools (Joey Yap, paipan.cn, Five Arts) — they use Lập Xuân + tiết khí which differ. Disagreement is by design, not a bug.

**Calendar engine input:** This SPEC consumes `normalized_birth_profile` from `TAO_LUNAR_CALENDAR_ALGORITHM_v1` which produces lunar year/month/day with Tết-aligned year and lunar-month-aligned month. No additional boundary computation needed in this SPEC.
...
| Version | Date | Change |
|---|---|---|
| v1.0 | 2026-04-25 | Initial — extracted from V3 PHẦN 2-13, PHẦN 15, Appendix A-E |
| v1.1 | 2026-04-29 | NTS school lock: Added explicit VN-school confirmation block (Tết year + lunar month). Bumped status from PROPOSED → DRAFT v1.1 awaiting NTS approval. No algorithm changes — this is a documentation clarification of existing default behavior. |
...
**END — TAO_ZIWEI_IMPLEMENTATION_SPEC_v1**
