# **TAO UZG+ CORE 01 — PHƯƠNG PHÁP AN SAO & LẬP LÁ SỐ TỬ VI CHUẨN**

## **Theo hệ Hi Di Trần Đoàn, đối chiếu Thiên Lương và chuẩn hóa cho TAO UZG+**

---

**Document Version:** V3.0 (CLEAN)
**Effective Date:** 2026-04-25
**Supersedes:** UZG_TAO_CORE_V2.md (2026-04-24)
**Cleanup applied:** C1-C10 per V2 LEGACY CLEANUP PLAN
**Renumbered:** Phụ lục 2-6 → Appendix B-F; 15.27 → Appendix A
**Removed:** PHẦN 7 cũ (duplicate); B/C/D/E cleanup-instruction blocks
**Preservation:** 100% canon content retained, only structure cleaned
...
# **PHẦN 8 — AN PHỤ TINH (ENTA TAO TECHNICAL SPEC)**
...
# **PHẦN 9 — AN CÁC VÒNG SAO LỚN (ENTA TAO TECHNICAL SPEC)**
...
# **PHẦN 10 — AN TỨ HÓA (DYNAMIC STATE SPECIFICATION)**
...
# **PHẦN 11 — KHỞI HẠN (TIMEFLOW ENGINE SPECIFICATION)**
...
# **PHẦN 12 — CHUẨN HÓA OUTPUT CỦA LÁ SỐ (OUTPUT NORMALIZATION SPEC)**
...
# **PHẦN 13 — KIỂM TRA SAI SỐ & CHUẨN HÓA THUẬT TOÁN (AUDIT & NORMALIZATION SPEC)**
...
# **PHẦN 14 — RANH GIỚI NGHIỆM LÝ (BOUNDARY OF INTERPRETATION SPEC)**
...
# **PHẦN 15 — PHỤ LỤC (ENTA TAO SUPPLEMENT / APPENDIX STANDARD)**
...
# **DOCUMENT STACK FINAL / AUTHORITY FINAL / PRECEDENCE FINAL**

## **DF.1. Document Stack Final**

Thứ tự chuẩn của toàn bộ bộ tài liệu TAO UZG+ CORE nên khóa như sau:

### **Tầng 1 — Constitution**

1. `TAO UZG+ CORE 01 — Core Method`  
2. `TAO UZG+ CANON OFFICIAL`  
3. `TAO UZG+ SYSTEM LAW`

### **Tầng 2 — Technical Core**

4. `TAO UZG+ APPENDIX TABLES`  
5. `TAO UZG+ APPENDIX 2 — Annual System`  
6. `TAO UZG+ APPENDIX 3 — Strength Matrix & Logic Gates`  
7. `TAO UZG+ APPENDIX 4 — Minor Cycle Canonical Table`  
8. `TAO UZG+ APPENDIX 5 — Full Canonical Aux Tables`  
9. `TAO UZG+ APPENDIX 6 — Priority / Resonance / Precedence`

### **Tầng 3 — Runtime & Product**

10. `TAO UZG+ OUTPUT SCHEMA`  
11. `TAO UZG+ AIER ADVISORY RULES`  
12. `TAO UZG+ QA / AUDIT CASEBOOK`

---

## **DF.2. Authority Final**

Thứ tự authority khóa cuối:

1. **Hi Di Trần Đoàn / Tử Vi Đẩu Số Toàn Thư**  
    → core star system, core structure, core heritage  
2. **Thiên Lương / Tử Vi Nghiệm Lý Toàn Thư**  
    → interpretive caution, vòng lớn, vận dụng phú, tuổi, Lộc Tồn, Tràng Sinh, Thái Tuế  
3. **Từ Tăng Sinh / Mệnh vận phân tích**  
    → multi-layer analysis, event validation, phi hóa, vận lưu chuyển, reasoning model  
4. **ENTA TAO Canonical Normalization**  
    → production tables, weighting, audit rules, runtime policy

---

## **DF.3. Precedence Final**

Khi có xung đột giữa các nguồn hoặc lớp logic, ưu tiên theo thứ tự:

### **Lớp 1 — Core Calculation Truth**
...
### **Lớp 2 — Canonical Runtime Table**

* production lookup tables  
* engine formulas  
* approved overlays

### **Lớp 3 — Interpretive Layer**
...
### **Lớp 4 — Advisory Personalization**

* AIER Tao language  
* contextual explanation  
* membership/service adaptation

### **Nguyên tắc**

* lớp dưới **không được override** lớp trên  
* nếu conflict:  
  * ưu tiên `core truth`  
  * sau đó `runtime table`  
  * cuối cùng mới đến `interpretation`

---

## **DF.4. Legacy Deprecation Note**

TAO phải thêm một mục cuối tài liệu:

**Các rule, bảng tra, hay logic trước phiên bản hiện hành nhưng không còn nằm trong Canonical Runtime Tables đều được xem là deprecated, không được phép dùng trong production hoặc advisory layer.**

---

# **ĐOẠN CHỐT CUỐI**

**Sau khi bổ sung bảng Tiểu Vận đủ 4 nhóm tam hợp, full canonical tables cho sao phụ còn lại, cùng lớp Priority / Resonance / Precedence và governance final, bộ tài liệu TAO UZG+ CORE đã đạt ngưỡng gần hoàn chỉnh cho production-scale deployment. Phần còn lại để khóa tuyệt đối là đóng gói lại toàn bộ file hiện tại thành một bản official final đã được renumber, dọn trùng lặp và gắn version history rõ ràng.**


---

# **V3 CLEANUP AUDIT TRAIL**

This V3 file was produced by executing the LEGACY CLEANUP PLAN (C1-C10) that was embedded in V2.

## **Changes applied**

| Cleanup | Action | V2 source | V3 location |
|---|---|---|---|
| C1 | Deleted PHẦN 7 cũ | V2 lines 2597-3066 | Removed |
| C1 | Kept PHẦN 7 final | V2 lines 3068-3478 | V3 PHẦN 7 (header normalized) |
| C8 | Moved 15.27 Tuần/Triệt to Appendix A | V2 lines 7604-7982 | V3 Appendix A |
| RENUMBER | PHỤ LỤC 2 → Appendix B | V2 lines 7984-8497 | V3 Appendix B |
| RENUMBER | PHỤ LỤC 3 → Appendix C | V2 lines 8499-8869 | V3 Appendix C |
| RENUMBER | PHỤ LỤC 4 → Appendix D | V2 lines 8871-8971 | V3 Appendix D |
| RENUMBER | PHỤ LỤC 5 → Appendix E | V2 lines 8973-9243 | V3 Appendix E |
| RENUMBER | PHỤ LỤC 6 → Appendix F | V2 lines 9245-9326 | V3 Appendix F |
| TOC | A. TOC FINAL → 0.6 Table of Contents | V2 lines 9426-9856 | V3 §0.6 (reformatted) |
| DROP | B. RENUMBER FINAL block | V2 lines 9858-9898 | DELETED (instruction completed) |
| DROP | C. LEGACY CLEANUP PLAN block | V2 lines 9900-10063 | DELETED (instruction completed) |
| DROP | D. FILE CLEANUP ORDER block | V2 lines 10065-10102 | DELETED (instruction completed) |
| DROP | E. KẾT LUẬN CHỐT block | V2 lines 10104-10120 | DELETED (was about cleanup itself) |

## **Subsection renumbering**

- `15.27.x` → `A.x` (Appendix A)
- `2.x` (Phụ lục 2) → `B.x` (Appendix B)
- `P3.x` → `C.x` (Appendix C)
- `P4.x` → `D.x` (Appendix D)
- `P5.x` → `E.x` (Appendix E)
- `P6.x` → `F.x` (Appendix F)
...
- All canon-grade content (PHẦN 0-15 + Appendix A-F + DOCUMENT FINAL) preserved verbatim.
- Only 1 PHẦN 7 retained (the FINAL/ENTA TAO STANDARD version).
- All ĐOẠN CHỐT (closing summaries) per PHẦN preserved.
- All JSON schema examples preserved.
- All test cases (NTS audit cases) preserved.

## **What V3 is ready for**

- Phase TAO-2: Split into 7 Master Stack documents (Canon, Architecture, Spec, Law, UI/UX, Roadmap, Build Task Map).
- Reference doc for CLAC-2 + Codex when implementing TAO module.
- Source of truth for AIER Tao context binding.
